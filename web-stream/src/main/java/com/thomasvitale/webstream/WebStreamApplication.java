package com.thomasvitale.webstream;
...
public class WebStreamApplication {

	private static final Logger log = LoggerFactory.getLogger(WebStreamApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(WebStreamApplication.class, args);
	}
	@Bean
